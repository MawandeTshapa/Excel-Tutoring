...
export default function HighSchool() {
  ...
  return (
    <div data-testid="highschool-page">
      <section className="relative overflow-hidden bg-[#050A15] text-white">
        ...
        <div className="container-x relative grid grid-cols-1 gap-16 py-24 md:py-32 lg:grid-cols-12">
          <div className="lg:col-span-7 stagger">
            <div className="eyebrow eyebrow-inverse">Grades 8–12 • CAPS</div>
            <h1 className="mt-4 font-display text-5xl font-semibold tracking-tighter md:text-7xl">Nail the basics. Earn the distinctions.</h1>
            <p className="mt-6 max-w-xl text-lg text-slate-300">Live, structured lessons for Mathematics, Physical Sciences and Life Sciences — aligned to the South African CAPS curriculum.</p>
      ...
      <section className="section bg-white">
        <div className="container-x">
          ...
          <h2 className="mt-4 font-display text-4xl font-semibold tracking-tight md:text-5xl">Subjects we tutor.</h2>
          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
            {mods.map((m) => (
              <div key={m.id} className="group rounded-2xl border border-slate-200 bg-white p-8 transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-900/5" data-testid={`hs-module-${m.id}`}>
                ...
                <div className="mt-4 inline-flex items-center gap-2 text-sm text-slate-500">Grades {m.grade_range}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section bg-slate-50">
        <div className="container-x grid grid-cols-1 gap-12 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <h2 className="mt-4 font-display text-4xl font-semibold tracking-tight md:text-5xl">Every plan includes.</h2>
          </div>
          <ul className="lg:col-span-7 grid grid-cols-1 gap-4 sm:grid-cols-2">
            {[
              "Live online lessons (Zoom / Meet)",
              "CAPS-aligned resources & past papers",
      ...
      <section className="section bg-[#1D4ED8] text-white">
        <div className="container-x flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
          <h2 className="font-display text-3xl font-semibold md:text-5xl">Ready to enrol?</h2>
